...
- [x] ✏️ Edit the README file (click the pencil icon) and add your favorite emoji here: <img width="20" height="20" src="https://user-images.githubusercontent.com/59897659/130674156-31ce5436-68fd-4229-864e-c20e920bb851.png">!
...
- [x] ✏️ This displays a help file with a list of possible commands. What does `log` do? **Log shows commit logs**
...
- [x] Use the CLI to navigate directories  
  ...
  - [x] Open this README file in Atom and paste that path here: **"C:\Users\19don\OneDrive\Desktop\Critical Web Design\learn-git-milestones\README.md"?**
...
- [x] Set up a [Github page](https://pages.github.com/) "project site" for your repo
  ...
  - [x] ✏️ Paste this link here: [My Project](https://aldonald81.github.io/my-awesome-project/)
